...
class LeakyDoubleConv(nn.Module):
    """(convolution => [BN] => ReLU) * 2"""
...
class LeakyDown(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.maxpool_conv = nn.Sequential(
            nn.MaxPool2d(2),
            LeakyDoubleConv(in_channels, out_channels)
        )
...
class LeakyUp(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        self.conv = LeakyDoubleConv(in_channels, out_channels)
