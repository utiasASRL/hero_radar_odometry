...
from utils.window_estimator_pseudo_nolm import WindowEstimatorPseudoNoLM
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='results/ir_super2_w6_win4_mah4_p8_gt_sobi6v/config.json', type=str,
    ...
    with torch.no_grad():
        ...
        #                                config['networks']['keypoint_loss']['error_thresh'])
        # solver = WindowEstimatorPseudo(10, 2, config['networks']['pseudo_temp'],
        #                                config['networks']['keypoint_loss']['error_thresh'])
        # solver = WindowEstimatorPseudo(10, 2, 50.0, 2.0)
        solver = WindowEstimatorPseudoNoLM(4, 50.0, 5)
